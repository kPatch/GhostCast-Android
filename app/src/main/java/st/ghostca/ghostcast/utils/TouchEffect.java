 ...
 * You can apply this to views mostly Buttons to provide Touch effect and that view must have a valid background.
 * The current implementation simply set Alpha value of View background.
 *
 */
